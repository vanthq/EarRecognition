...
parser.add_argument('--result_path', default='resnet(resnetMAX101)', type=str,
...
parser.add_argument('--resume', default='True', type=str, metavar='C:\\Users\\86152\\Desktop\\results\\model_best.pth.tar',
...
parser.add_argument('--n_classes', default=500, type=int,
...
parser.add_argument('--nesterov', action='store_true', default=True, help='Nesterov momentum')
...
parser.add_argument('--train_crop_size', default=128, type=int,
                    help='The crop size for training. default: 224')
parser.add_argument('--val_resize', default=128, type=int,
                    help='The value to resize the shorter size of the image (for validation). default: 256')
parser.add_argument('--val_crop_size', default=128, type=int,
