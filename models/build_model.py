...
def build_model(args):
    ...
    if args.arch == 'vgg16':
        model=models.vgg16(pretrained=False,num_classes=args.n_classes)
    if args.arch == 'vgg13':
        model=models.vgg13(pretrained=False,num_classes=args.n_classes)
    if args.arch == 'googlenet':
        model=models.googlenet(pretrained=False,num_classes=args.n_classes,init_weights=True)
